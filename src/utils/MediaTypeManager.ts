...
export class MediaTypeManager {
	...
	updateTemplates(settings: MediaDbPluginSettings): void {
		...
		this.mediaFileNameTemplateMap.set(MediaType.Comic, settings.comicFileNameTemplate);
		...
		this.mediaTemplateMap.set(MediaType.Comic, settings.comicTemplate);
	...
	updateFolders(settings: MediaDbPluginSettings): void {
		...
		this.mediaFolderMap.set(MediaType.Comic, settings.comicFolder);
	...
	createMediaTypeModelFromMediaType(obj: any, mediaType: MediaType): MediaTypeModel {
		...
		} else if (mediaType === MediaType.Comic) {
			return new ComicModel(obj);
